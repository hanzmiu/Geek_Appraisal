...
1. 当Huffman树的叶结点为n时，整个生成树的结点总数为何是2n-1？
   ...
   Huffman树的节点的度为0或2，因此叶节点为n时，度为2的节点数为n-1，因此节点总数为2n-1

2. 该代码可以对大写字母的字符串进行huffman编码，如果要读小写字母字符串进行编码，应该如何修改？如果想要对同时具有大写和小写字母的字符串都进行编码呢（写出思路即可）？

3. ![屏幕截图_20221104_132934](E:\作业\c语言\Geek_Appraisal\task2\屏幕截图_20221104_132934.png)使用画图工具画出上述两个Huffman生成树的生成过程

![屏幕截图_20221104_132946](C:\Users\29717\Pictures\Screenshots\屏幕截图_20221104_132946.png)
